...
public class BancoDados extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CRIAR_TABELA = "CREATE TABLE " + TABELA_PESSOA + "(" + COLUNA_CODIGO  + " INTEGER PRIMARY KEY AUTOINCREMENT,"  + COLUNA_NOME + " TEXT," + COLUNA_EMAIL + " TEXT," + COLUNA_TELEFONE + " TEXT," + COLUNA_ENDERECO + " TEXT)";
