...
public class FrmCarro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblAcentos = new javax.swing.JLabel();
        lblTipo = new javax.swing.JLabel();
        lblAlugado = new javax.swing.JLabel();
        ...
        txtAcentos = new javax.swing.JTextField();
        txtTipo = new javax.swing.JTextField();
        txtAlugado = new javax.swing.JTextField();
        ...
        jLabel1.setText("Cadastramento de Veiculos no estacionamento");
        ...
        lblAcentos.setText("Acentos");

        lblTipo.setText("Tipo de automovel");

        lblAlugado.setText("Alugado?");

        txtAlugado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtAlugadoActionPerformed(evt);
            }
        });

        jLabel2.setText("SIM OU NÂO");
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                                            ...
                                            .addComponent(txtChassi, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addComponent(lblAlugado)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(txtAlugado, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addComponent(lblAcentos)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(txtAcentos, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(txtTorque, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGap(38, 38, 38)
                                        .addComponent(txtProprietario, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(lblAlugado)
                                .addComponent(txtAlugado, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addComponent(txtAcentos, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel2)
                .addGap(11, 11, 11)
                .addComponent(lblMensagem)
        ...
        tblConsulta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Placa", "Cor", "Descrição", "Proprietario", "Marca", "Modelo", "Torque", "Tamanho", "Chassi", "Acentos", "Tipo", "Alugado"
            }
        ) {
    ...
    private void btnIncluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnIncluirMouseClicked
        ...
        cb.setTorque(txtTorque.getText());
        cb.setTamanho(txtTamanho.getText());
        cb.setChassi(txtChassi.getText());
        cb.setAcentos(txtAcentos.getText());
        cb.setTipo(txtTipo.getText());
        cb.setAlugado(txtAlugado.getText());
            ...
            DefaultTableModel tbm = 
                    (DefaultTableModel)tblConsulta.getModel();
                        ...
                        for(CarroBean cb : listaCarro){
                            ...
                            tblConsulta.setValueAt(cb.getModelo(), i, 5);
                            tblConsulta.setValueAt(cb.getTorque(), i, 6);
                            tblConsulta.setValueAt(cb.getTamanho(), i, 7);
                            tblConsulta.setValueAt(cb.getChassi(), i, 8);
                            tblConsulta.setValueAt(cb.getAcentos(), i, 9);
                            tblConsulta.setValueAt(cb.getTipo(), i, 10);
                            tblConsulta.setValueAt(cb.getAlugado(), i, 11);
                            i++;
                        }
                        Conexao.fecharConexao(con);
    ...
    private void btnExcluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnExcluirMouseClicked
        ...
        int i = JOptionPane.showOptionDialog(null,
                "Deseja Excluir esse veiculo:"+txtPlaca.getText()+"?","exclusão",
    ...
    private void txtAlugadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtAlugadoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtAlugadoActionPerformed
    ...
    private javax.swing.JLabel lblAcentos;
    private javax.swing.JLabel lblAlugado;
    ...
    private javax.swing.JTextField txtAcentos;
    private javax.swing.JTextField txtAlugado;
